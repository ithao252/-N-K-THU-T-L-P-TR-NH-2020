...
bool ValidPass(char x)	//Qui ước <PASSWORD> từ kí tự 33 đến 126(cac so hoac ki hieu hoac chu hoa va thuong co tren ban phim)
{
	if (x >= 33 && x <= 126)
		return true;
	return false;
